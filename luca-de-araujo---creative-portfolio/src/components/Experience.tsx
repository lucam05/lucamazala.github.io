...
const experiences = [
  {
    role: 'Estagiário de Gestão de Projetos',
    company: 'Redspark',
  ...
  {
    role: 'Gerente de I&D / Consultor de Projetos',
      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-20">
           <div className="flex flex-col gap-4">
            <span className="text-[#00FF00] font-mono text-xs uppercase tracking-[0.3em]">03 / Experiência</span>
            <h2 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter">Experiência Profissional</h2>
          </div>
